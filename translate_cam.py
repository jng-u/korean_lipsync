...
if __name__ == '__main__':
    ...
    parser.add_argument('--landmark-model', dest='face_landmark_shape_file', type=str, 
                        default='shape_predictor_68_face_landmarks.dat', help='Face landmark model file.')
    parser.add_argument('--model', dest='frozen_model_file', type=str, help='Frozen TensorFlow model file.')
